...
export class AdministratorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.administratorService
      ...
      .subscribe(
        (res: HttpResponse<IAdministrator[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInAdministrators(): void {
    this.eventSubscriber = this.eventManager.subscribe('administratorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAdministrator[] | null, headers: HttpHeaders, page: number): void {
