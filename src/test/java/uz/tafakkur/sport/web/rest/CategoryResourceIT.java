...
import uz.tafakkur.sport.repository.CategoryRepository;
import uz.tafakkur.sport.service.CategoryService;
import uz.tafakkur.sport.service.dto.CategoryDTO;
import uz.tafakkur.sport.service.mapper.CategoryMapper;
...
public class CategoryResourceIT {
    ...
    public void createCategory() throws Exception {
        ...
        restCategoryMockMvc
            .perform(
                post("/api/categories").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(categoryDTO))
            )
    ...
    public void updateCategory() throws Exception {
        ...
        restCategoryMockMvc
            .perform(put("/api/categories").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(categoryDTO)))
            .andExpect(status().isOk());
