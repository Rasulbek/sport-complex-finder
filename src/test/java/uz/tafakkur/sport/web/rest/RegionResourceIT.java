...
import uz.tafakkur.sport.repository.RegionRepository;
import uz.tafakkur.sport.service.RegionService;
import uz.tafakkur.sport.service.dto.RegionDTO;
import uz.tafakkur.sport.service.mapper.RegionMapper;
...
public class RegionResourceIT {
    ...
    public void createRegion() throws Exception {
        ...
        restRegionMockMvc
            .perform(post("/api/regions").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(regionDTO)))
    ...
    public void getRegion() throws Exception {
        ...
        // Get the region
        restRegionMockMvc
            .perform(get("/api/regions/{id}", region.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingRegion() throws Exception {
        // Get the region
        restRegionMockMvc.perform(get("/api/regions/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateRegion() throws Exception {
        ...
        restRegionMockMvc
            .perform(put("/api/regions").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(regionDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteRegion() throws Exception {
        ...
        // Delete the region
        restRegionMockMvc
            .perform(delete("/api/regions/{id}", region.getId()).accept(MediaType.APPLICATION_JSON))
