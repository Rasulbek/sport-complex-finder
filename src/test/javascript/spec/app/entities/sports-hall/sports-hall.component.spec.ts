...
import { SportsHallComponent } from 'app/entities/sports-hall/sports-hall.component';
...
describe('Component Tests', () => {
  describe('SportsHall Management Component', () => {
    let comp: SportsHallComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SportsHallComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sportsHalls && comp.sportsHalls[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
